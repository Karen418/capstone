  ...
  for (Hand hand : leap.getHands ()) {
    ...
    for (Finger finger : hand.getFingers()) {
      ...
      case 2:
        ...
        finger3X = fingerPosition.x;  // ***
        finger3Y = fingerPosition.y;  // ***
        break;
      case 3:
        // System.out.println("ring");

        finger4X = fingerPosition.x;  // ***
        finger4Y = fingerPosition.y;  // ***
        break;
      case 4:
        // System.out.println("pinky");
        
        finger5X = fingerPosition.x;  // ***
        finger5Y = fingerPosition.y;  // ***
        break;
      }
